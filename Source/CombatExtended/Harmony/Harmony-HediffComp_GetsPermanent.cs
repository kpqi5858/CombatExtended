...
namespace CombatExtended.Harmony
{
    ...
    //I don't have idea for this patch because vanila changed this much
    //So disable it
    ...
    static class HediffComp_GetsPermanent_CompPostInjuryHeal_Patch
    {
        static readonly string logPrefix = Assembly.GetExecutingAssembly().GetName().Name + " :: " + typeof(HediffComp_GetsPermanent_CompPostInjuryHeal_Patch).Name + " :: ";
        ...
        static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator il)
        {
            ...
            MethodInfo newMath = AccessTools.Method(typeof(HediffComp_GetsPermanent_CompPostInjuryHeal_Patch), "ClampedValue");
            ...
            if (tendLocal != null)
            {
                foreach (CodeInstruction instruction in instructions)
                {
                    ...
                    if (patchPhase == 5 && HarmonyBase.OpcodeStoreIndex(instruction) >= 0)
                    {
                        ...
                        // insert the call
                        yield return new CodeInstruction(OpCodes.Call, AccessTools.Method(typeof(HediffComp_GetsPermanent_CompPostInjuryHeal_Patch), "ClampedValue"));
