...
namespace CombatExtended.Harmony
{
    ...
    internal static class Harmony_DamageWorker_AddInjury_ApplyDamageToPart
    {
        ...
        internal static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            curCode.operand = typeof(Harmony_DamageWorker_AddInjury_ApplyDamageToPart)
                .GetMethod(nameof(Harmony_DamageWorker_AddInjury_ApplyDamageToPart.ArmorReroute), AccessTools.all);

            // Load the dinfo we just modified and we want to access its damage value to store in the vanilla local variable at the end of the block
